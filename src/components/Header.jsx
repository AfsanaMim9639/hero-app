...
export default function Header() {
  ...
  backgroundImage: "linear-gradient(90deg, #632EE3, #9F62F2)",
  borderBottom: "3px solid",
  borderImageSlice: 1,
  borderImageSource: "linear-gradient(90deg, #632EE3, #9F62F2)"
};
  ...
  return (
    <header className="bg-white shadow-md px-10 py-4 flex justify-between items-center relative">
      ...
      <NavLink to="/" className="flex items-center gap-3">
        ...
        <span className="text-2xl font-bold uppercase bg-clip-text text-transparent" style={gradientStyle2}>
          HERO.IO
        </span>
      </NavLink>
            ...
            className={({ isActive }) =>
              `font-semibold transition-transform duration-200 ${
                isActive
                  ...
                  : "text-black hover:scale-105 hover:bg-clip-text hover:text-transparent"
              }`
            }
            style={({ isActive }) => (isActive ? gradientStyle : { color: "black" })}
